...
df = fetch_data(curr_dir / "sample.parquet")
size = df.size
clicks = 0
                    ...
                    children=[
                        html.H1(
                            ...
                            children=[
                                ...
                                html.Span(" dataset.", className="main-title-element"),
                            ],
                        ),
                        html.H2("Click on any column to sort", className="sub-title"),
                        html.H2(
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        dcc.Graph(id="static-map-figure", figure=create_static_map(df)),
                    ],
                ),
            ],
        ),
...
def update_table(page_current, column, ascending, n_clicks, dropdown, input_val):
    ...
    return (
        data.iloc[page_current * PAGE_SIZE : (page_current + 1) * PAGE_SIZE].to_dict(
            "records"
        ),
        page_current,
    )
